...
@AndroidEntryPoint
class Buses1Fragment : Fragment() {
    private lateinit var binding: FragmentBuses1Binding
    ...
    override fun onCreateView(
        ...
        Log.d("HelloWorld","1")
        binding = FragmentBuses1Binding.inflate(inflater,container,false)
        busesViewModel = ViewModelProvider(this).get(BusesViewModel::class.java)
        busesViewModel.getBusesDetail("Buses1").observe(viewLifecycleOwner, Observer {
        ...
        binding.Search.setOnClickListener (View.OnClickListener{
            ...
            if (binding.etSearch.text.isEmpty()){
                ...
                busesViewModel.BusesTimimg("Buses1",binding.etSearch.text.toString()).observe(viewLifecycleOwner,
                    Observer {
                        list.add(it)
                        binding.busRecycler.layoutManager = LinearLayoutManager(activity)
